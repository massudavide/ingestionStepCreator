package ingestion_step_creator_aux.OozieProperties
...
object createOozieProperties {
  ...
  def oozieObjectsProperties(processName: String):String = {
    ...
    if(processName=="dco"){
      objPropString += "workflowPath=${oozieHdfsPath}/bin/workflow_dco.xml\n"
    }
    else{
      objPropString += "workflowPath=${oozieHdfsPath}/bin/workflow_summerbi.xml\n"
    }
